...
$Zip = Join-Path $Out "enshrouded-server-manager.zip"
$Stage = Join-Path $Out "enshrouded-server-manager"
...
Copy-Item -LiteralPath (Join-Path $PSScriptRoot "Launch Manager.bat") -Destination (Join-Path $Stage "enshrouded_manager")
